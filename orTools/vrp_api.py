...
if couriers_with_specific_capacity:
    ...
    for courier in couriers:
        if 'capacity' in courier:
            ...
            courier_capacities_12.append(courier.get("capacity_12", 0))
            courier_capacities_19.append(courier.get("capacity_19", 0))
...
if solution:
    ...
    for vehicle_id in range(num_couriers):
        ...
        if route_orders:
            ...
            courier_has_specific_bottles = 'capacity' not in couriers[vehicle_id]
