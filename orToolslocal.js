...
export default async function orTools() {
    ...
    const allOrders = [
        ...
        { id: 'order_3', 'lat': 43.151319, 'lon': 76.901267, 'bottles_12': 0, 'bottles_19': 3, 'status': "awaitingOrder", 'date.time': "10:00 - 13:00", 'priority': 1, 'isUrgent': true},
        { id: 'order_4', 'lat': 43.228644, 'lon': 76.866358, 'bottles_12': 0, 'bottles_19': 3, 'status': "awaitingOrder", 'date.time': "10:35 - 13:40", 'priority': 1, 'isUrgent': true},
        { id: 'order_5', 'lat': 43.187654, 'lon': 76.898765, 'bottles_12': 0, 'bottles_19': 2, 'status': "awaitingOrder", 'priority': 2, 'isUrgent': false},
        { id: 'order_6', 'lat': 43.254082, 'lon': 76.918261, 'bottles_12': 0, 'bottles_19': 5, 'status': "awaitingOrder", 'date.time': "9:30 - 18:00", 'priority': 1, 'isUrgent': false},
